...
import com.microservice.order.dto.PurchaseRequest;
import com.microservice.order.dto.PurchaseResponse;
...
public class ProductClient {
    ...
    public List<PurchaseResponse> purchaseResponses(List<PurchaseRequest> requests) {
        ...
        if (responseEntity.getStatusCode().isError()) {
            throw new BusinessException("Error while proc: " + responseEntity.getStatusCode());
        }
